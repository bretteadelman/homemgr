    ...
    case 0:
      return (
        <>
          ...
          <p style={{ fontSize: 14, color: 'rgba(28,40,25,0.5)', margin: '0 0 28px' }}>
    ...
    case 1:
      return (
        <>
          ...
          <p style={{ fontSize: 14, color: 'rgba(28,40,25,0.5)', margin: '0 0 28px' }}>Select the closest fit.</p>
    ...
    case 2:
      return (
        <>
          ...
          <p style={{ fontSize: 14, color: 'rgba(28,40,25,0.5)', margin: '0 0 28px' }}>Select up to 3.</p>
    ...
    case 4:
      return (
        <>
          ...
          <p style={{ fontSize: 14, color: 'rgba(28,40,25,0.5)', margin: '0 0 28px' }}>We'll match you with households that fit.</p>
    ...
    case 5:
      return (
        <>
          ...
          <p style={{ fontSize: 14, color: 'rgba(28,40,25,0.5)', margin: '0 0 28px' }}>Select your range or preferred approach.</p>
    ...
    case 6:
      return (
        <>
          ...
          <p style={{ fontSize: 14, color: 'rgba(28,40,25,0.5)', margin: '0 0 28px' }}>From past households or employers.</p>
    ...
    case 7:
      return (
        <>
          ...
          <p style={{ fontSize: 14, color: 'rgba(28,40,25,0.5)', margin: '0 0 16px' }}>
          ...
          <div style={{
            ...
            borderRadius: 10, fontSize: 13, color: 'rgba(28,40,25,0.5)', lineHeight: 1.6, marginBottom: 20,
          }}>
    ...
    case 8:
      return (
        <>
          ...
          <p style={{ fontSize: 14, color: 'rgba(28,40,25,0.5)', margin: '0 0 28px' }}>Our team reviews every application personally.</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: 12, color: 'rgba(28,40,25,0.5)', marginBottom: 6, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Phone *</label>
              <input type="tel" value={formData.phone || ''} onChange={e => updateField('phone', e.target.value)}
                placeholder="(323) 555-0100" aria-label="Phone" style={inputStyle} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 12, color: 'rgba(28,40,25,0.5)', marginBottom: 6, letterSpacing: '0.05em', textTransform: 'uppercase' }}>LinkedIn URL (optional)</label>
          ...
          <>
            ...
            <div style={{ padding: '24px 28px 0', flexShrink: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
                <div>
                  <div style={{ fontSize: 12, color: 'rgba(28,40,25,0.4)', letterSpacing: '0.05em', marginBottom: 2, ...sans }}>
